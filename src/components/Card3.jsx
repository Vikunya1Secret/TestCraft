...
const Card3 = forwardRef(({ handleDelete, errors = [], id }, ref) => {
  const [options, setOptions] = useState([
    { id: 1, text: "Правильный ответ", ball: "-" },
    { id: 2, text: "Правильный ответ", ball: "-" },
  ])
  ...
  const addOption = () => {
    ...
    setOptions([...options, { id: newId, text: "Правильный ответ", ball: "-" }])
  }
    ...
    <div id={id} className="mb-6 question-card-shadow bg-white p-9 rounded-2xl">
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="flex items-center gap-x-8 mt-4">
          <div className="flex items-center gap-x-3">
            ...
            />
            <p className="text-[16px] font-semibold text-[#F68D88]">Учитывать регистр</p>
          </div>
          <div className="flex items-center gap-x-3">
            <input
              className="w-4 h-4 border-2 border-[#F68D88] accent-[#F68D88] rounded"
            ...
            />
            <p className="text-[16px] font-semibold text-[#F68D88]">Точное совпадение</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-between">
        ...
        >
          ...
          <span className="ml-2 text-[#3D568F] font-semibold text-[16px]">Добавить вариант ответа</span>
        </button>
        <button
